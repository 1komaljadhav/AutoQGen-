...
echo"Time: 3 hrs. <div style='float:right;'>Max. Marks: 20</div> <br>";
...
switch($v){
   case 1: 
   $query1= "SELECT * from question where marks=4 and module='$x' and sname='$subject' and difficultylevel='$b[0]' order by RAND() limit 1";
   ...
   if(isset($b) && count($b) >= 2) {
    $query2= "SELECT * from question where marks=4 and module='$x' and sname='$subject' and difficultylevel='$b[0]' order by RAND() limit 1";
    $res2= mysqli_query($con, $query2);
} else {
    // Handle the case when $b is not set or doesn't have enough elements
    // For example, you can set a default value for $b[1] or log an error
    echo "Error: $b is not set or doesn't have enough elements.";
}
...
echo"<b>USN </b><img src='images/usn.jpg' height='40px;' align='middle'> <b style='float:right;'>".$re2[0]."</b>";
echo"<h2> <center>" .$subject. "</center> </h2>";
echo"Time: 3 hrs. <div style='float:right;'>Max. Marks: 40</div> <br>";
echo"<br> <b> <i style='margin-left:25px;'>Note: Answer any FIVE full questions, choosing one full question from each module. </i> </b> <br> <br>";
//module 1
function pick_theory_questionsm1($used_questions,$z1,$v,$w, $f)
{
