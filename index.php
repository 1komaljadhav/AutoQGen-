...
<li><a href="faculty/registration.php"><span class="far fa-address-card"></span><p>Registration</p></a></li>
<li><a href="admin/login.php"><span class="	fa fa-television"></span><p>Login</p></a></li>
					
					<li><a href="#contact"><span class="fa fa-map-marker"></span><p>Contact</p></a></li>
					<li><a href="#about" style="margin-top:10px;"><span class="fa fa-question"></span><p>About</p></a></li>
					<li><a href="#team" style="margin-top:20px;"><span class="fa fa-users"></span><p>Team</p></a></li>
		...
		<div id="main-content">
				...
				<div class="banner_w3lspvt">
					<div class="banner-top1">
						...
						<div class="container">
							...
							<img src='images/viit.png' width=300px height=100px>
			...
			<!-- about -->
			<div class="welcome py-5" id="about" style="padding-left:150px">
				<div class="container py-xl-5 py-lg-3">
					<div class="row py-xl-4">
						<div class="col-lg-6 welcome-left pr-lg-5">
							...
							Thus with the help of this system we present the solution in form Question Paper Generator System(AutoQGen) which makes use of shuffling algorithm as a randomization technique.
			...
			<!-- team -->
			<section class="team py-5" id="team" style="padding-left:150px">
            <h3 class="title text-uppercase text-center text-bl mb-5 pb-xl-3">OUR TEAM</h3>
				<div class="container py-xl-5 py-lg-3" >
				<div class="container">
                    <div class="row" style="padding-left:160">
                        <div class="col-md-4 col-sm-4" >
                            <div class="team-member" >
                                <div class="team-img" >
                                    <img src="images/rutuja.jpg" alt="team member" class="img-responsive" height="300px">
                                </div>
                            ...
                            <div class="team-title">
                                <h5 style="margin-left:15%;">Rutuja Sonawane</h5>
                            </div>
                        </div>
                        <div class="col-md-4 col-sm-4">
                            <div class="team-member">
                                <div class="team-img">
                                    <img src="images/komal p.jpg" alt="team member" height="300px" class="img-responsive">
                                </div>
                                <div class="team-hover">
                                    <div class="desk">
					...
					<a href=""><i class="fab fa-github"></i></a>
                            ...
                            <div class="team-title">
                                <h5 style="margin-left:20%;">Komal Patankar</h5>
                            </div>
                        </div>
			   <div class="col-md-4 col-sm-4">
                            <div class="team-member">
                                <div class="team-img" style="">
                                    <img src="images/pic.jpg" alt="team member" height="300px"class="img-responsive" style="transform: rotate(0deg);">
                                </div>
                                <div class="team-hover">
                                    <div class="desk">
					...
					<a href=""><i class="fab fa-github"></i></a>
                            ...
                            <div class="team-title">
                                <h5  style="margin-left:15%;">Komal Jadhav</h5>
                            </div>
                        </div>
			...
			<!-- contact -->
			<section class="contact py-5" id="contact" style="padding-left:150px">
				<div class="container py-xl-5 py-lg-3 ">
					...
					<div class="row mail-w3l-w3pvt-web pt-xl-4">
						<div class="col-md-5 contact-left-w3ls">
							...
							<div class="row mail-w3 my-4">
								...
								<div class="col-md-10 col-sm-10 col-10 contact-text-w3pvt-webinf0">
									<h4>Mail us</h4>
									<p><a href="mailto:info@example.com">jadhavkomal518@gmail.com</a></p>
								</div>
							</div>
							<div class="row call">
								<div class="col-md-2 col-sm-2 col-2 contact-icon-wthree">
