                ...
                <div class="row" style="min-height:500px">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
							...
							<th><button  type="submit" name="submit1" style="border:none; display: inline-block; margin-left:15px; border-radius:30px;"> <img src="images/search.png" height="20px" width="20px" style="border-radius:10px; display: block;"></button>
							</th> </tr> </table> </form>
							<?php
